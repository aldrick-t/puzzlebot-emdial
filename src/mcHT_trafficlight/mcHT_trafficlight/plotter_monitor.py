...
class LivePlotNode(Node):
    def __init__(self):
        ...
        self.times_v,   self.v_vals    = deque(maxlen=10000), deque(maxlen=10000)
        self.times_w,   self.w_vals    = deque(maxlen=10000), deque(maxlen=10000)
        self.ctrl_t,    self.cmd_v     = deque(maxlen=10000), deque(maxlen=10000)
        self.ctrl_t_w,  self.cmd_w     = deque(maxlen=10000), deque(maxlen=10000)
        self.err_t,     self.ed        = deque(maxlen=10000), deque(maxlen=10000)
        self.err_t_th,  self.etheta    = deque(maxlen=10000), deque(maxlen=10000)
        self.x_data,    self.y_data    = deque(maxlen=10000), deque(maxlen=10000)
        self.goals                         = []  # list of (xg, yg)
        self.last_goal                     = None

        # buffers for “remaining to goal”
        self.rem_t,    self.rem_dist     = deque(maxlen=10000), deque(maxlen=10000)
        self.rem_t_th, self.rem_angle    = deque(maxlen=10000), deque(maxlen=10000)
